...
cal = Tk()
cal.title("DERRICK TAB'S CALCULATOR")
cal.configure(background = "grey")
cal.geometry('{}x{}+0+0'.format(cal.winfo_screenwidth(), cal.winfo_screenheight()))
operator = ""
text_Input = StringVar()

textDisplay = Entry(cal, font=('arial', 20, 'bold'), textvariable = text_Input, bd=28, insertwidth=4, bg = "cyan", justify = 'right').grid(columnspan = 4)
...
btnClear = Button(cal, padx = 16, bd = 8, fg = "black", font = ('arial', 20, 'bold'), text = "C", bg = "yellow", command = btnClearDisplay).grid(row = 4, column = 1)

btnEquals = Button(cal, padx = 16, bd = 8, fg = "black", font = ('arial', 20, 'bold'), text = "=", bg = "cyan", command = btnEqualsInput).grid(row = 4, column = 2)
